...
/// <summary>
/// Defines the general variables and Methods for all interactable item objects
/// Abstract Class: Not ment to be implemented directly.
/// </summary>
public abstract class InteractableItemSO : ItemSO
{
    //public GameObject UI_Virtual_Joystick_Interact; //TODOING Implementation
    //public Sprite interactItemUI; //TODOING Implementation
    //public Animator playerAnimator; //TODO Implementation
    //public StarterAssetsInputs starterAssetsInputs; //Esto es un scriptable object con los inputs. Podría crear el mío propio en vez de modificar ese.
